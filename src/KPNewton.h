...
public:
  ...
  double ComputeTMax(const std::vector<std::complex<double>> &x,
...
private:
  ...
  std::vector<std::vector<double>> MeshAnglesFromFaceEdgeLen2(
      const std::vector<std::vector<double>> &len2) const;

  std::vector<std::complex<double>> result;
  std::vector<std::vector<int>> tri;
  std::vector<std::size_t> assembleorder;
